function tctooltip(options){
    ...
    const getElementPosition = function(element){
        ...
        let boundariesAdj = {
            ...
            left:boundaries.left + document.documentElement.scrollLeft
        };
    ...
    const positionOfBox = (box, element) => {
        ...
        const correctRight = () => box.style.left = document.documentElement.scrollLeft + 'px';
        const correctLeft = () => box.style.left = window.innerWidth + document.documentElement.scrollLeft - boxSize.width + 'px';
        const correctTop = () => box.style.top = window.innerHeight + document.documentElement.scrollTop - boxSize.height + 'px';
        const correctBottom = () => box.style.top = document.documentElement.scrollTop + 'px';
    ...
    const placeTooltipBox = function(box, trigger, i, evt){
        ...
        if(options.position === 'left'){
            boxLocation.left();
            if(box.offsetLeft - document.documentElement.scrollLeft < 0){
                boxLocation.right();
        ...
        if(options.position === 'right'){
            boxLocation.right();
            if(box.offsetLeft + box.offsetWidth - document.documentElement.scrollLeft > window.innerWidth){
                boxLocation.left();
